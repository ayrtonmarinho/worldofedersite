...
//let monstro = new Enemy("Azarkoth", 10, 1, "Normal", 0, 0, 0, 0, 0, 0, "Arco", 4, true);


function createEnemy() {

    let nome = document.getElementById('nome').value;
    let baseVida = document.getElementById('vida_base').value;
    let nivel = document.getElementById('nivel').value;
    let tier = document.getElementById('tier').value;
    let armadura = document.getElementById('armadura').valeu;
    let arma = document.getElementById('arma').select.value;
